...
// 3. τσεκάρουμε αν έχει επιλεγεί τουλάχιστον ένας τρόπος επικοινωνίας
// 4. τσεκάρουμε αν έχει επιλεγεί τουλάχιστον ένας τομέας ενδιαφέροντος
// 5. τσεκάρουμε αν έχει επιλεγεί τουλάχιστον ένα checkbox που αφορά την εκμάθηση ξένων γλωσσών
// 6. τσεκάρουμε αν έχει επιλεγεί το checkbox για τους Όρους & Απόρρητο
...
window.addEventListener('load', function(){
    ...
    // θέτουμε έναν event listener για να ελέγξουμε την ημ/νια όταν εκείνη αλλάζει
    ...
    // θέτουμε έναν event listener για να ελέγξουμε τον δεύτερο κωδικό όταν εκείνος αλλάζει
    ...
    // θέτουμε έναν event listener για να ελέγξουμε τον πρώτο κωδικό όταν εκείνος αλλάζει 
    ...
    // θέτουμε έναν event listener όταν γίνεται κλικ στο κουμπί της εγγραφής
    ...
    button.addEventListener('click', function(){
        ...
        let checkbox = document.getElementById('cb_agreement')
 
        if(!checkbox.checked){
            checkbox.setCustomValidity('Θα πρέπει να αποδεχτείται τους Όρους & Απόρρητο για να συνεχίσετε')
        }else{
